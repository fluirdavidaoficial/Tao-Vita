...
export function AtlasImage({
  ...
  return (
    <div className={cn("relative overflow-hidden bg-border/60", className)}>
      ...
      {failed ? (
        ...
        <img
          ...
          className={cn(
            "atlas-plate size-full transition-opacity duration-[400ms] ease-[cubic-bezier(0.22,1,0.36,1)]",
