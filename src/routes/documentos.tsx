  ...
  return (
    <>
      ...
      <p className="mt-1 text-sm text-muted">
        Versões leves para o app. Homologação e galeria abrem no navegador; o PDF curto cobre o produto.
      </p>
      ...
      <div className="surface-card mt-5 p-4">
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0 flex-1">
            <h2 className="font-display text-xl leading-tight">Documentação do produto</h2>
            <p className="mt-1 text-sm text-muted">Escopo, rotas, protocolos, arquitetura e limites.</p>
            <p className="mt-1 text-xs tabular-nums text-subtle">324 KB</p>
      ...
      <p className="mt-1 text-sm text-muted">HTML leve, sem pacote de dezenas de megas.</p>
