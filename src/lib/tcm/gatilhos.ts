...
export const TRIGGER_VIEWS: { id: TriggerView; t: string; src: string; aspect: string }[] = [
  { id: "back-upper", t: "Costas · alto", src: "/images/trigger/back-upper.jpg?v=2", aspect: "800/882" },
  { id: "back-lower", t: "Costas · baixo", src: "/images/trigger/back-lower.jpg?v=2", aspect: "800/857" },
  { id: "front", t: "Frente", src: "/images/trigger/front.jpg?v=2", aspect: "800/1106" },
  { id: "neck", t: "Cabeça e pescoço", src: "/images/trigger/neck.jpg?v=2", aspect: "800/1089" },
  { id: "leg-front", t: "Perna · frente", src: "/images/trigger/leg-front.jpg?v=2", aspect: "800/2169" },
  { id: "leg-back", t: "Perna · trás", src: "/images/trigger/leg-back.jpg?v=2", aspect: "800/1846" },
  { id: "foot", t: "Planta do pé", src: "/images/trigger/foot.jpg?v=2", aspect: "800/1133" },
  { id: "arm", t: "Braço · frente", src: "/images/trigger/arm.jpg?v=2", aspect: "800/2014" },
  { id: "arm-dorsal", t: "Braço · dorso", src: "/images/trigger/arm-dorsal.jpg?v=2", aspect: "800/1575" },
];
...
export const TRIGGER_POINTS: TriggerPoint[] = [
  /* —— Lombar e ciática —— */
  P("ql", "Q. lombar", "Quadrado lombar", "lombar", "back-lower", 40, 24,
  ...
  P("sps", "Serrato post. sup.", "Serrato posterior superior", "torax", "back-upper", 38, 56,
    "Sob a escápula alta, costelas 2–5, fundo.",
    "Escápula, ombro posterior e bordo ulnar do membro (até o 5º dedo)."),

  /* —— Cervical e cabeça —— */
  P("trap-up", "Trapézio alto", "Trapézio (fibras superiores)", "cervical", "neck", 61, 70,
  ...
  P("masseter", "Masseter", "Masseter", "cervical", "neck", 35, 47,
  ...
  /* —— Coxa e joelho —— */
  P("gmin", "Glúteo mín.", "Glúteo mínimo", "coxa", "back-lower", 26, 64,
  ...
  P("vl1", "Vasto lat. alto", "Vasto lateral (alto)", "coxa", "leg-front", 54, 23,
  ...
  P("delt", "Deltoide", "Deltoide", "ombro", "arm", 64, 18,
  ...
  P("opp", "Oponente", "Oponente do polegar", "mao", "arm", 46, 78,
    "Eminência tenar, proximal ao adutor — palpe o ventre carnoso da base do polegar.",
    "Polegar e tenar. Travamento da pinça."),
];
